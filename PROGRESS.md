...
### 导师档案
- [x] 导师认证后可填写「我的导师档案」（职业年限、个人介绍、头像照片）
- [x] 合并「过往项目经验」与「高光成绩」为单一自由文本「个人介绍」
- [x] 新人侧「查看导师档案」可展开卡片，展示导师照片/姓名/年限/介绍

### 社交分享
- [x] 新增 opengraph-image.tsx（1200×630 橙色渐变 OG 图）
- [x] layout.tsx + login/page.tsx 完整 OG / Twitter Card meta 标签
- [x] 简化 favicon：32×32 橙色渐变 + 「秘」字，在聊天窗口清晰可辨
...
- [x] 导师考试支持重新测试：移除已有证书时的重定向锁，结果页同时展示得分详情与「🔄 重新测试」按钮（通过时额外保留「查看证书」入口）
...
| 2026-04-14 | 导师考试支持重新测试：结果页展示得分，通过/未通过均可点击「🔄 重新测试」重来 |
| 2026-04-17 | 导师档案功能：导师填写职业年限+个人介绍+上传照片；新人侧可展开「查看导师档案」卡片 |
| 2026-04-17 | 合并「过往项目经验」和「高光成绩」为单一「个人介绍」自由文本字段 |
| 2026-04-17 | 社交分享优化：新增 OG 图片（opengraph-image.tsx）、完整 OG/Twitter Card meta 标签、简化 favicon（橙色渐变+「秘」字） |
